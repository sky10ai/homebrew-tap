class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.18.0/sky10-darwin-arm64"
      sha256 "ee34904888254f5258670da36a739298e72781cd7f01597dab3f49f137f31376"
    else
