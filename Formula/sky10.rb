class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.10.4/sky10-darwin-arm64"
      sha256 "4a342c632fd55848a0925fe0370e6feb7ec52bf294cc0516ca797e80c0d316e0"
    else
