class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.8/sky10-darwin-arm64"
      sha256 "20922e5a208678afbe54f77d192e399e0eb3de36574eafdab8726b5488caebed"
    else
