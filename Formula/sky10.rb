class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.5/sky10-darwin-arm64"
      sha256 "cf8d2696a51c1c9d65f74a8e906b09267c08f9fb5239256a2ddd9c3e9c16a2e3"
    else
