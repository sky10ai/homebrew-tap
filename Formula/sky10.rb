class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.11/sky10-darwin-arm64"
      sha256 "23cac052d4f7f5f202827f1d61718338f0bb02f1fc62cd08b9d545f57a8c7dc4"
    else
