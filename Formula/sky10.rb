class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.11.4/sky10-darwin-arm64"
      sha256 "44e301d1d9de2ad60381e856cf38d6d55f5cfbf76f5533b7f4671e4f060fa318"
    else
