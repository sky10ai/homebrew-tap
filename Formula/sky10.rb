class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.11.0/sky10-darwin-arm64"
      sha256 "347e6a5dac810cea2333cd41d5428cfeed694161dd88246f0e46fbb11f02965f"
    else
