class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.0/sky10-darwin-arm64"
      sha256 "1edcb522ef260b4df40b55c3f8edb96d9c2eff63a8cbfaaa4dbaa867fbf98dcd"
    else
