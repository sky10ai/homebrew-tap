class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.24.0/sky10-darwin-arm64"
      sha256 "895989f0fc4573d26b6040f79e7e21788c4e83447f30e3948d75b2b264430f44"
    else
