class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.10.2/sky10-darwin-arm64"
      sha256 "0033361b6a39d7b32fee7837a9d0453c3000ba9a8c1c584c774c0c872b2e4000"
    else
