class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.3/sky10-darwin-arm64"
      sha256 "f03d01022be284707eae373b762d467bb6daf86b6db9f73d4bfbc2e800ffa281"
    else
