class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.12.0/sky10-darwin-arm64"
      sha256 "b143c2cb942bbc5f30df61a34d2ba5d6e912c7444c34a08c3d6231c256b5d41b"
    else
