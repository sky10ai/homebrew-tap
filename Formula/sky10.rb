class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.6.2/sky10-darwin-arm64"
      sha256 "ec80322de4a7b771c73f0009f0842a719c2cc6aaccded6802457383c021b67c9"
    else
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "887cf93dc4a97c4c3e1c317db3540.6.2b4ccc9c15362b84e68311d2a32b328e"
    else
      url "https://github.com/sky10ai/sky10/releases/download/v0.4.2/sky10-linux-amd64"
      sha256 "4bd23af461b2f27d34e44325d0b419a45c20f0.6.27757e495389c5394114fe9"
    end
  end
