class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.25.0/sky10-darwin-arm64"
      sha256 "ec4a4d9f7220c05a8406d1570e53c78817ffb937c65230c842e121bd6aa483e0"
    else
