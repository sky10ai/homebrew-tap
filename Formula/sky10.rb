class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.2/sky10-darwin-arm64"
      sha256 "f324fb764724464212888be06c6c8e5b0a9196b267ccd9d8a721169fd0a8cf33"
    else
