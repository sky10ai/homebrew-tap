class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.30.3/sky10-darwin-arm64"
      sha256 "da9585f1ec1c3c521c4d0882d684c58661f357eaf26e91727b036a0a78f6ade7"
    end
  end
