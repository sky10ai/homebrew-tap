class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.21.4/sky10-darwin-arm64"
      sha256 "a780b3921046d70f53541beb1263609109f1740e275a2856be5032e16d6a50b8"
    else
