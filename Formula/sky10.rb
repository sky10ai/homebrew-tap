class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.24.1/sky10-darwin-arm64"
      sha256 "649a20e6466b6f5f6029a8789db44241a07c861c8842da3c2c704f9581e1b413"
    else
