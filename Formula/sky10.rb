class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.15.0/sky10-darwin-arm64"
      sha256 "e02d89609ce2f52fa3b0da48b8c778e1eff835e76d3b653c1d7817a173855af8"
    else
