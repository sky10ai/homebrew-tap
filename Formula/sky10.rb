class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.18.1/sky10-darwin-arm64"
      sha256 "f74568ac5a8ea7cab7a23bb4e8f4ace1a7b7cf4dd7660092ef4cea8dd885ef6a"
    else
