class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.21.0/sky10-darwin-arm64"
      sha256 "a9f140969025124d75821037437432dc0b2a173659be3576e2c93142303b742a"
    else
