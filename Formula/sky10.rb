class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.10.0/sky10-darwin-arm64"
      sha256 "6e7a6f2f82bcf05522a5dac7dfe50dda595b288af7c0306ba348ef325ed09054"
    else
