class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.17.5/sky10-darwin-arm64"
      sha256 "bde2029c690df1c592a24762811b975bb4df3cade75d6f55ad31224dcc583d36"
    else
