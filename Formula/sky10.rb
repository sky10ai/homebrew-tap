class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.21.2/sky10-darwin-arm64"
      sha256 "9183c43209d0d53918e997a10761089b4ebb9fce186ec8787f57b45e7863c320"
    else
