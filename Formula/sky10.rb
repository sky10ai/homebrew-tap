class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.24.3/sky10-darwin-arm64"
      sha256 "e18d01ab4f33563645407b44a2df2fb879e994cd8511e4bf60acfe2e567abebd"
    else
