class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.17.0/sky10-darwin-arm64"
      sha256 "1fbee2c7cf95cd2f80bb80b473c60aed1ce708f32f8bc45ff3d14fc5ce8c9dcd"
    else
