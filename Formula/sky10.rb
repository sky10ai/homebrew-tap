class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.4/sky10-darwin-arm64"
      sha256 "d5580e9fe09c1611ac467301ee5db00277ec0e600ce2091b09ba3ba9c06d527c"
    else
