class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.8.0/sky10-darwin-arm64"
      sha256 "455fab3c90d6b0d49234787111aa160546b0118ed7cc99605c9ffcb03c8ed9ce"
    else
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "887cf93dc4a97c4c3e1c317db3540.8.0b4ccc9c15362b84e68311d2a32b328e"
    else
      url "https://github.com/sky10ai/sky10/releases/download/v0.4.2/sky10-linux-amd64"
      sha256 "4bd23af461b2f27d34e44325d0b419a45c20f0.8.07757e495389c5394114fe9"
    end
  end
