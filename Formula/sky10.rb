class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.17.6/sky10-darwin-arm64"
      sha256 "10cec8b7f00c70c2618efe1146fd89971ce0ec8cd8f33d8a33f955783f0f307c"
    else
