class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.23.0/sky10-darwin-arm64"
      sha256 "8cd29786aad15cd75cb399c6dc70ca6e19668f683bdedef91fa4b1d449c51c93"
    else
