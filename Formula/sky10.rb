class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.9/sky10-darwin-arm64"
      sha256 "353967780b60b9daafb717fe0e3376a4b69eab86d32821d7fb4d784eb66bdc37"
    else
