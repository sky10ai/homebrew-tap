class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.10.1/sky10-darwin-arm64"
      sha256 "c303ce15985097696590ba7de57cf04e5ccfa8e507a30f58912950c800ccd4d2"
    else
