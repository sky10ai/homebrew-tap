class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.11.7/sky10-darwin-arm64"
      sha256 "4b74877df9872ebc3d49fe5a791f5226515719b565d053c88bd36ddbdb21522a"
    else
