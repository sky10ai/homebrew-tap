class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.5.1/sky10-darwin-arm64"
      sha256 "32fd095c9be84242194f6f6fa63c2a60253e611e8239313df682280eaf2b971e"
    else
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "887cf93dc4a97c4c3e1c317db3540.5.1b4ccc9c15362b84e68311d2a32b328e"
    else
      url "https://github.com/sky10ai/sky10/releases/download/v0.4.2/sky10-linux-amd64"
      sha256 "4bd23af461b2f27d34e44325d0b419a45c20f0.5.17757e495389c5394114fe9"
    end
  end
