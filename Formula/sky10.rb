class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.17.1/sky10-darwin-arm64"
      sha256 "f65786f7e4dc68e32d8f6a1bafc3998b7d3d33fb4a595504f94cf45d7809c98f"
    else
