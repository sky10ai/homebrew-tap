class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.11.5/sky10-darwin-arm64"
      sha256 "bc1c71d7f7f531f06fdeb14fa5d4e8063534afb8176af2fb593e3f90c83b1fb5"
    else
