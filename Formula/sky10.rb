class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.24.2/sky10-darwin-arm64"
      sha256 "28298461fd906ee7c410b36fcdab4e8a3cf2214578deeb29dbf35096a9f07b04"
    else
