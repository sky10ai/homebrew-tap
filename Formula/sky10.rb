class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.1/sky10-darwin-arm64"
      sha256 "fba21ba7c47365881c901dfd13251cb57bab9e72428aca8d4ff038ecccb424af"
    else
