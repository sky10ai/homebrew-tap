class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.21.3/sky10-darwin-arm64"
      sha256 "e25706dfbea4a7724473332c3f1de924eae5f2cbe9501a14b01506f46c2f2640"
    else
