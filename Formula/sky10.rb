class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.16.0/sky10-darwin-arm64"
      sha256 "baa5bc20694be0ca79956a58c2cbff88a2b3fffc34ae02337e5c1582344532e7"
    else
