class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.13.10/sky10-darwin-arm64"
      sha256 "ca9a153d21e4755542354cc92aca35d5213a485ad007a69147ce08067d0122c0"
    else
