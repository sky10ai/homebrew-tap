class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.11.6/sky10-darwin-arm64"
      sha256 "c2bc0640d8537d1feb083695823a5c38a577a02c63e30ad1bef2399f4c9877d4"
    else
