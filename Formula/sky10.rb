class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.16.2/sky10-darwin-arm64"
      sha256 "dec0189adcd9441cc93a8c3fbec788326ac07724ead7280be4078580a6450185"
    else
