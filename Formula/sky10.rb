class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.21.1/sky10-darwin-arm64"
      sha256 "18e523438cd8890bb18c493382b22b10a7c941f3fe900ac37de27169d883237a"
    else
