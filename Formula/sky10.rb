class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.11.1/sky10-darwin-arm64"
      sha256 "5a92ba24a612e93a7532d4846dd7676cd552d3fd89858321d83685dc3933e435"
    else
