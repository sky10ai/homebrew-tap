class Sky10 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/sky10ai/sky10/releases/download/v0.15.1/sky10-darwin-arm64"
      sha256 "e36c0316edce061281dde4447a2bf49f934e8a7e7e17b40956990c945e280f89"
    else
